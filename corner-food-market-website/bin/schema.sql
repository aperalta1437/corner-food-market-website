...
CREATE TYPE ADMINISTRATOR_PERMISSION AS ENUM (
    'CREATE_ITEM',
    'READ_ITEM',
    'UPDATE_ITEM',
    'DELETE_ITEM',
...
CREATE TABLE ADMINISTRATOR(
    ...
    TFA_CODE VARCHAR(64),
    TFA_EXPIRATION_TIME BIGINT,
    TFA_CHOSEN_TYPE TFA_TYPE,
    PERMISSIONS ADMINISTRATOR_PERMISSION ARRAY,
...
-- Every new administrator request for the same email will overwrite the one previously made.
...
CREATE TABLE ITEM(
    ...
    IS_POPULAR BOOLEAN NOT NULL,                    -- Determines if an item appears in the customer landing page with popular items.
    POPULARITY_SORT_NUMBER SMALLINT NOT NULL,
    HAS_FIXED_POPULARITY BOOLEAN NOT NULL,
...
CREATE TABLE ITEM_IMAGE(
    ...
    SORT_NUMBER SMALLINT NOT NULL,                  -- SMALLINT datatype because SORT_NUMBER will be used in a number of images per item basis.
