...
-- TODO: Figure out how to handle discount all types of discount in the database and back-end.
...
--  _2FA_CODE VARCHAR(45),
--  _2FA_EXPIRE_TIME VARCHAR(45),
--  _2FA_DEFAULT_TYPE VARCHAR(10),
  CREATED_AT TIMESTAMP WITHOUT TIME ZONE NOT NULL,
  MODIFIED_AT TIMESTAMP WITHOUT TIME ZONE,
  PRIMARY KEY(ID)
);
