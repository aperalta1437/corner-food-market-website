...
CREATE TABLE ITEM(
  ...
  DELETED_AT TIMESTAMP WITHOUT TIME ZONE,
  PRIMARY KEY(ID),
  CONSTRAINT FK_ITEM_CATEGORY_HIERARCHY
      FOREIGN KEY(CATEGORY_ID)
          REFERENCES ITEM_CATEGORY_HIERARCHY(ID),
...
CREATE TABLE ITEM_IMAGE(
  ...
  RELATIVE_PATH_ID SMALLINT NOT NULL,
  CREATED_AT TIMESTAMP WITHOUT TIME ZONE,
  MODIFIED_AT TIMESTAMP WITHOUT TIME ZONE,
  DELETED_AT TIMESTAMP WITHOUT TIME ZONE,
  PRIMARY KEY(ID),
  CONSTRAINT FK_FILE_RELATIVE_PATH
    FOREIGN KEY(RELATIVE_PATH_ID)
...
CREATE TABLE FILE_TYPE(
    ID SMALLSERIAL,
    NAME AS VARCHAR(50) NOT NULL UNIQUE,
    DESCRIPTION TEXT NOT NULL,
    CREATED_AT TIMESTAMP WITHOUT TIME ZONE,
    MODIFIED_AT TIMESTAMP WITHOUT TIME ZONE,
    DELETED_AT TIMESTAMP WITHOUT TIME ZONE,
...
CREATE TABLE ITEM_CATEGORY_HIERARCHY(
    ID SMALLSERIAL,
    NAME AS VARCHAR(25) NOT NULL UNIQUE,
    DESCRIPTION TEXT NOT NULL,
