...
function AdminLoginPage() {
  ...
  const fromRoute = (location.state !== undefined && location.state.fromRoute !== undefined) ? location.state.fromRoute : null;
        ...
        <section className="content-main">
          ...
          >
            <div className="card-body">
              ...
              {
              loginIssueMessage ? (<div className="alert alert-danger" role="alert">
                {loginIssueMessage}
              </div>) : null
              }

              <Switch>
                <Route path="/admin/login" exact component={(props) => <AdminLoginForm fromRoute={fromRoute} />} />
              </Switch>
