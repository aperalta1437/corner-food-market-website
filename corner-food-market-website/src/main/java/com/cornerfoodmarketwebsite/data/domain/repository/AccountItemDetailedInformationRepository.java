...
//    AccountItemDetailedInformation findBySku(String itemSku, short customerId);
    ...
    @Query(nativeQuery = true, value =
            "SELECT I1.ID, I1.NAME, I1.DESCRIPTION, I1.SKU, I1.PRICE, I1.IS_ON_SALE, I1.IS_POPULAR, D1.IS_PERCENTAGE_BASED, D1.DISCOUNT_PERCENT, D1.DISCOUNT_AMOUNT, II1.QUANTITY, IC1.NAME, IC1.URL_ROUTE_NAME, CI1.CUSTOMER_ID, CI1.IN_CART_QUANTITY " +
            "FROM ITEM I1 " +
