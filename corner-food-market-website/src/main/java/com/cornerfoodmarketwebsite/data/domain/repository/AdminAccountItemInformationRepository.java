...
@Repository
public interface AdminAccountItemInformationRepository extends JpaRepository<AdminAccountItemInformation, Short> {
...
//    Iterable<AccountItemInformation> findAllOnSale(@Param("customerId") short customerId);
    ...
    Iterable<AdminAccountItemInformation> findAllOnSale();
