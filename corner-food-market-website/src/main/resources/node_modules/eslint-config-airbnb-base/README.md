...
1. Install the correct versions of each package, which are listed by the command:
  ...
  ```sh
  npx install-peerdeps --dev eslint-configuration-airbnb-base
  ```
  ...
  ```sh
  (
    export PKG=eslint-configuration-airbnb-base;
  ...
  ```sh
    npm install --save-dev eslint-configuration-airbnb-base eslint@^#.#.# eslint-plugin-import@^#.#.#
  ```
  ...
  install-peerdeps --dev eslint-configuration-airbnb-base
  ```
...
1. Install the correct versions of each package, which are listed by the command:
  ...
  ```sh
  npm install --save-dev eslint-configuration-airbnb-base eslint@^3.0.1 eslint-plugin-import@^1.10.3
  ```
